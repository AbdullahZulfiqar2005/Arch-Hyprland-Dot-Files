...
declare -A online_music=(
  ["YT - Snowfall"]="https://youtu.be/LlN8MPS7KQs?feature=shared"
  ["YT - Christmas Kids"]="https://youtu.be/J6GE0XnIv7A?feature=shared"
  ["YT - Succession"]="https://youtu.be/LlgWqcHXD8w?feature=shared"
  ["YT - DS Theme"]="https://youtu.be/OV1i4MoIDAg?feature=shared"
)
...
play_online_music() {
  ...
  mpv --loop --input-ipc-server=/tmp/mpvsocket --shuffle --vid=no "$link"
