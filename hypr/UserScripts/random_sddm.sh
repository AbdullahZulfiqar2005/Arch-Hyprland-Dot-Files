...
sudo /usr/bin/cp "$random_wall" "$sddm_wallpaper_dir/default"
sudo /usr/bin/chown root:root "$sddm_wallpaper_dir/default"
sudo /usr/bin/chmod 644 "$sddm_wallpaper_dir/default"
