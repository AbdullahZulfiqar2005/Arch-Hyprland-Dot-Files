...
WALLPAPER_LIST="$HOME/.config/hypr/UserScripts/wall2.txt"

# File to keep track of already used wallpapers
USED_FILE="$HOME/.config/hypr/UserScripts/.used_wallpapers2.txt"
...
echo "$WALLPAPER_DIR/$WALLPAPER" >> "$USED_FILE"
